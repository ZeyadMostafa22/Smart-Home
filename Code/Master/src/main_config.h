...
#define BLOCK_MODE_TIME (u32)5000
#define CHARACTER_PREVIEW_TIME (u16)75
#define DOOR_TIME (u32)1200
...
// #define ROOM1_MAIN_MENU (u8)5
// #define ROOM2_MAIN_MENU (u8)6
// #define ROOM3_MAIN_MENU (u8)7
// #define ROOM4_MAIN_MENU (u8)8

// #define ROOM1_MANUAL_MENU (u8)11
// #define ROOM2_MANUAL_MENU (u8)12
// #define ROOM3_MANUAL_MENU (u8)13
// #define ROOM4_MANUAL_MENU (u8)14

#define FAN_AUTO_MENU (u8)13
// #define FAN_MANUAL_MENU (u8)12
// #define FAN_MAIN_MENU (u8)14

// #define FIRST_TIME_LOGIN_MENU (u8)15
// #define LOGIN_MENU (u8)16
/*****************************************************************************************/
/****************************   UART codes  *****************************************/

// #define FAN_TURN_ON (u8)'N'
// #define FAN_TURN_OFF (u8)'F'
// #define OPEN_STATUS 'o'
// #define CLOSED_STATUS 'c'
// #define DOOR_CLOSE 'C'
// #define DOOR_OPEN 'O'
// #define OFF_STATUS (u8)'f'
// #define ON_STATUS (u8)'n'
